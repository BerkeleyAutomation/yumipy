...
try:
    ...
    raise RuntimeError("yumi_arm_service unavailable outside of catkin package")

try:
    from yumipy.srv import ROSYumiArm
except ImportError:
    raise RuntimeError('ROSYumiArm service not available, did you run catkin?')
...
if __name__ == '__main__':
    ...
    rospy.loginfo('{} arm is ready'.format(name))
